# Contributing to stapel-categories
...
```bash
git clone https://github.com/usestapel/stapel-categories.git && cd stapel-categories
...
- **No new hardcoded behavior.** Anything a host project might want to
  ...
  (`STAPEL_CATEGORIES` dict; see `conf.py`) — with a dotted-path
